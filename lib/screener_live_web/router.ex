defmodule ScreenerLiveWeb.Router do
  use ScreenerLiveWeb, :router
  # , scope: "/admin", pipe_through: [:some_plug, :authenticate]
  use Kaffy.Routes

  import ScreenerLiveWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ScreenerLiveWeb.Telemetry
    end
  end
