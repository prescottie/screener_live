defmodule ScreenerLiveWeb.UserAuthTest do
  use ScreenerLiveWeb.ConnCase, async: true

  alias ScreenerLive.Accounts
  alias ScreenerLiveWeb.UserAuth
  import ScreenerLive.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ScreenerLiveWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ScreenerLiveWeb.Endpoint.subscribe(live_socket_id)
